...
### Overview
Final thesis submitted in June 2020 for the *[Masters of Applied Statistics](https://master.stat.ucla.edu/)* degree at UCLA. The goal of this research was to build a model using NBA data that could systematically beat the market's moneyline betting odds. Study was conducted in three phases:
